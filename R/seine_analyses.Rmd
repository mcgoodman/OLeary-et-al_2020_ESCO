...
seine_pairs <- RVAideMemoire::pairwise.perm.manova(
  seine_bray, fact = ordination_groups,
  p.method = "fdr", nperm = 10000
)

seine_pairs_p <- as.data.frame(round(seine_pairs$p.value, digits = 3))
knitr::kable(seine_pairs_p)
```
